...
* Developed stakeholder-ready visualizations within the company’s BI platform to enable data-driven decision-making

**Hard Skills**: 
<br> Python, SQL, MS Excel (Power Query, Power Pivot), Power BI,  R.

**Certifications**:
* Yandex EdTech. Certificate of Completion of the Data Scientist Professional Training Course, 2024
* 국가공인 자격증. 데이터 분석 준전문가 (Data Analytics Semi-Professional), 2025
...
<br>**Project 2:** [Samsung YouTube Channel Data Analysis](https://github.com/rinaguskova/Data-Analysis-Portfolio/tree/main/YT%20API%20Project)
